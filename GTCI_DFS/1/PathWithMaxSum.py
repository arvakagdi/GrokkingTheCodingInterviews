...
#     maxsum = 0
#     find_maximum_path_sum_rec(root,maxsum)
#     return maxsum

# def find_maximum_path_sum_rec(node, maxsum):
#     if node is None:
#         return 0
    
#     leftsum = find_maximum_path_sum_rec(node.left, maxsum)
#     rightsum = find_maximum_path_sum_rec(node.right, maxsum)
